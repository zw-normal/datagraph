...
from engine.writer.vega_stacked_area import Form as VegaStackedAreaForm
from engine.tests import CommonTestCase


class VegaLineTestCase(CommonTestCase.WriterTestCase):
    node_name = 'vega_stacked_area'
    ...
    form_class = VegaStackedAreaForm
    ...
    def assertProcess(self, result):
        self.assertTrue(
            'Vega lite stacked area chart specification.' in result)
